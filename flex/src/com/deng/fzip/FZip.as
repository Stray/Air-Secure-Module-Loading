...
package com.deng.fzip
{
	 ...
	 * loaded successfully.
	 *
	 * @eventType com.deng.fzip.FZipEvent.FILE_LOADED
	 */
	[Event(name="fileLoaded", type="com.deng.fzip.FZipEvent")]

	/**
	 * Dispatched when an error is encountered while parsing a 
	 * ZIP Archive.
	 *
	 * @eventType com.deng.fzip.FZipErrorEvent.PARSE_ERROR
	 */
	[Event(name="parseError", type="com.deng.fzip.FZipErrorEvent")]
